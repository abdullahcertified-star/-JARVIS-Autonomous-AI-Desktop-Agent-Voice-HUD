...
EDGE_URDU_PITCH: str = os.getenv("JARVIS_EDGE_URDU_PITCH", "-2Hz")
EDGE_URDU_RATE: str = os.getenv("JARVIS_EDGE_URDU_RATE", "-4%")
EDGE_HINGLISH_VOICE: str = os.getenv("JARVIS_EDGE_HINGLISH_VOICE", "hi-IN-MadhurNeural")
EDGE_HINGLISH_PITCH: str = os.getenv("JARVIS_EDGE_HINGLISH_PITCH", "-2Hz")
EDGE_HINGLISH_RATE: str = os.getenv("JARVIS_EDGE_HINGLISH_RATE", "-3%")
